...
# 点击坐标
position = [[987,226],[445,329],[231,240],[325,778],[1735,17],[1184,891],[1059,516],[1196,719]]
# 进入剪映
...
pyautogui.click(button='left')
pyautogui.alert(text='请选择导出路径,并选择导出视频，选择完成路径后点击确认',title='PyAutoGUI消息框',button='OK')
time.sleep(5)
# 确认
...
time.sleep(90)
# 输入关键词
pyautogui.moveTo(position[6][0],position[6][1],duration=1)
pyperclip.copy("#小说推文每日更新")    
pyautogui.click(button='left')
pyautogui.hotkey('ctrl','a')
# 模拟按下Ctrl+V粘贴
...
time.sleep(5)
# 发布
pyautogui.moveTo(position[7][0],position[7][1],duration=1)
pyautogui.click(button='left')
time.sleep(1)
# # 删除轨道中素材
pyautogui.moveTo(position[2][0],position[2][1],duration=1)
